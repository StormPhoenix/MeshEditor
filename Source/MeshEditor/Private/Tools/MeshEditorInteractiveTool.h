...
#include "MeshEditorInteractiveTool.generated.h"


/**
 * Builder for UMeshEditorInteractiveTool
 */
UCLASS()
class MESHEDITOR_API UMeshEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UMeshEditorInteractiveTool
 */
UCLASS(Transient)
class MESHEDITOR_API UMeshEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UMeshEditorInteractiveToolProperties();
...
/**
 * UMeshEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class MESHEDITOR_API UMeshEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UMeshEditorInteractiveToolProperties> Properties;
